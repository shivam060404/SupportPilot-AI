...
@af.tool(name="create_ticket", description="Create a new IT support ticket. Use this when an issue cannot be resolved immediately and requires IT staff intervention.")
