...
from backend.app.api.schemas import ChatRequest, ChatResponse, HealthResponse, ErrorResponse
from backend.app.observability.logger import get_logger, bind_trace_context, clear_trace_context
from backend.app.observability.request_context import set_request_context, clear_request_context
from backend.app.observability.tooltrace import start_tool_trace, stop_tool_trace, start_artifacts, collect_artifacts
from backend.app.ai.guardrails.pipeline import GuardrailPipeline
...
async def chat(request: Request, body: ChatRequest) -> ChatResponse:
    ...
    agent: KnowledgeableITSupportAgent = request.app.state.agent
