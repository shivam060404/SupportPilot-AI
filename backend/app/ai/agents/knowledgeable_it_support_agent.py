"""
backend/app/ai/agents/knowledgeable_it_support_agent.py
──────────────────────────────
Orchestrates the SupportPilot AI MAF workflow.

This orchestrates the application routing and integration components.
"""
import uuid
...
from backend.app.ai.agents.privileged_access_escalation_agent import create_privileged_access_escalation_agent
from backend.app.ai.prompts.it_support_prompt import SYSTEM_PROMPT
from backend.app.ai.tools.search_knowledge_base import search_knowledge_base
from backend.app.ai.tools.check_service_status import check_service_status
from backend.app.ai.tools.create_ticket import create_ticket
from backend.app.ai.tools.get_ticket_status import get_ticket_status
...
from backend.app.integrations.groq_client import create_groq_client
...
class KnowledgeableITSupportAgent:
    """
    ...
    def __init__(self) -> None:
        ...
        self._history_provider = PostgreSQLHistoryProvider()
        ...
        escalation_agent = create_privileged_access_escalation_agent(
            client=self._client,
            history_provider=self._history_provider,
        )
    ...
    async def chat(self, message: str, session_id: str) -> dict:
        ...
        try:
            ...
            from backend.app.observability.tooltrace import collect_artifacts
