"""
backend/app/ai/guardrails/input/pii_detector.py
──────────────────────────────────────
...
from backend.app.ai.guardrails.base import GuardrailBase, GuardrailResult, ViolationSeverity, GuardrailViolation
from backend.app.core.privacy.pii_patterns import PIIType
