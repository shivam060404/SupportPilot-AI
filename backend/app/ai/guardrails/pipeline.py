"""
backend/app/ai/guardrails/pipeline.py
────────────────────────────
...
from backend.app.ai.guardrails.base import GuardrailBase, GuardrailResult, ViolationSeverity
from backend.app.ai.guardrails.input.pii_detector import PIIDetectorGuardrail
...
from backend.app.ai.guardrails.input.contextual_compliance import ContextualComplianceGuardrail
...
from backend.app.ai.guardrails.output.output_validation import OutputValidationGuardrail
...
class GuardrailPipeline:
    ...
    def _audit_block(
        ...
        try:
            from backend.app.persistence.repositories import AuditLogRepository
