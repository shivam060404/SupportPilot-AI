"""Centralised environment-backed application settings."""
...
class Settings(BaseSettings):
    ...
    database_url: str = Field(
        default="postgresql+psycopg://supportpilot:supportpilot@localhost:5432/supportpilot"
    )

    # ── Vector Store (Phase 2) ───────────────────────────────────────────────
    chroma_persist_dir: str = Field(default=str(ROOT_DIR / "data" / "runtime" / "chroma"))
