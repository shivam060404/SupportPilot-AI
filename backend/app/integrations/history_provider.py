"""
backend/app/integrations/history_provider.py
────────────────────────────────────
Custom MAF HistoryProvider that persists conversation state to PostgreSQL.
...
class PostgreSQLHistoryProvider(af.HistoryProvider):
    def __init__(self, source_id: str = "postgresql-history-provider", **kwargs):
