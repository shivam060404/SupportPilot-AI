...
from backend.app.persistence.models import Ticket, AuditLog, SessionMessage, ApprovalRequest, utc_now
...
class SessionRepository:
    ...
    def save_messages(session_id: str, messages_json: list[str]) -> None:
        ...
        """
        from backend.app.persistence.models import SessionMessage
