...
def configure_logging() -> None:
    ...
    # Lazy import to avoid circular imports (backend/app/core/middleware imports logger)
    try:
        from backend.app.core.middleware.secrets_filter import SecretsFilterProcessor
        from backend.app.core.middleware.pii_redaction import PIIRedactionProcessor
